...
- `SUBMISSION.md` — coverage output, design decisions, and closing notes
...
`{"assignee": null}` clears the assignment. Empty or whitespace-only names are
rejected with `400`; an unknown task id returns `404`.
